...
namespace BillingAddress\Customer\Block;
 ...
 */
class ShippingEdit extends \Magento\Directory\Block\Data {
    ...
    \Magento\Framework\View\Element\Template\Context $context, \Magento\Directory\Helper\Data $directoryHelper, \Magento\Framework\Json\EncoderInterface $jsonEncoder, \Magento\Framework\App\Cache\Type\Config $configCacheType, \Magento\Directory\Model\ResourceModel\Region\CollectionFactory $regionCollectionFactory, \Magento\Directory\Model\ResourceModel\Country\CollectionFactory $countryCollectionFactory, \Magento\Customer\Model\Session $customerSession, \Magento\Customer\Api\AddressRepositoryInterface $addressRepository, \Magento\Customer\Api\Data\AddressInterfaceFactory $addressDataFactory, \Magento\Customer\Helper\Session\CurrentCustomer $currentCustomer, \Magento\Framework\Api\DataObjectHelper $dataObjectHelper, array $data = []
        ...
        parent::__construct(
                $context, $directoryHelper, $jsonEncoder, $configCacheType, $regionCollectionFactory, $countryCollectionFactory, $data
        );
    }
    ...
    protected function _prepareLayout() {
        ...
        try {
            if ($shippingAddressId) {
                $this->_address = $this->_addressRepository->getById($shippingAddressId);
            }
        } catch (Exception $e) {
        ...
        if ($postedData = $this->_customerSession->getAddressFormData(true)) {
            ...
            $this->dataObjectHelper->populateWithArray(
                    $this->_address, $postedData, '\Magento\Customer\Api\Data\AddressInterface'
            );
        }
    ...
    public function getSaveUrl() {
        return $this->_urlBuilder->getUrl(
                        'customer/address/saveAddress', ['_secure' => true, 'id' => $this->getAddress()->getId()]
        );
    }
