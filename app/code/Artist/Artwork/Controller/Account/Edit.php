...
class Edit extends \Magento\Customer\Controller\AbstractAccount {
    ...
    Context $context, Session $customerSession, PageFactory $resultPageFactory, CustomerRepositoryInterface $customerRepository, DataObjectHelper $dataObjectHelper
    ) {
...
//        $artwork_id = intval($this->getRequest()->getParam('id'));
//        $artwork = array();
...
//        }
//
//        if ($artwork['artist_id'] != $customerId) {
//            $resultRedirect = $this->resultRedirectFactory->create();
//            return $resultRedirect->setPath('artwork/account/shop');
//        }
        $resultPage->getConfig()->getTitle()->set(__('Edit Artwork'));
