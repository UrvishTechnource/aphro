...
class EditPost extends \Magento\Customer\Controller\Account\EditPost
{
	...
	$canc_acc = $_POST['canc_acc'];
		...
		$customerCandidateDataObject->setCustomAttribute('canc_acc', $canc_acc);
		...
		$lastCustomerId = $this->getCustomerDataObject($this->session->getCustomerId());
