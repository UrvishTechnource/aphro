...
namespace Techprof\EditProf\Controller\Account;
...
class EditPost extends \Magento\Customer\Controller\Account\EditPost {
    ...
    public function execute() {
        ...
        if ($validFormKey && $this->getRequest()->isPost()) {
            ...
            $_POST['facebook'] = str_replace(array('http://', 'https://'), '', ltrim(addslashes($_POST['facebook']), '//'));
            $_POST['twitter'] = str_replace(array('http://', 'https://'), '', ltrim(addslashes($_POST['twitter']), '//'));
            $_POST['instagram'] = str_replace(array('http://', 'https://'), '', ltrim(addslashes($_POST['instagram']), '//'));
            $_POST['pinterest'] = str_replace(array('http://', 'https://'), '', ltrim(addslashes($_POST['pinterest']), '//'));

            $this->getRequest()->setParam('facebook', $_POST['facebook']);
            $this->getRequest()->setParam('twitter', $_POST['twitter']);
            $this->getRequest()->setParam('instagram', $_POST['instagram']);
            $this->getRequest()->setParam('pinterest', $_POST['pinterest']);
            ...
            try {
                ...
                $this->getEmailNotification()->credentialsChanged(
                        $customerCandidateDataObject, $currentCustomerDataObject->getEmail(), $isPasswordChanged
                );
